				...
				<div class="offcanvas offcanvas-end" data-bs-backdrop="static" tabindex="-1" id="logisticsNavbar" aria-labelledby="logisticsNavbarLabel">
					...
					<div class="offcanvas-body">
						<ul class="navbar-nav gap-30 gap-lg-40 justify-content-end flex-grow-1 align-items-xl-center">	
							<li class="nav-item dropdown">
								<a class="nav-link active d-inline-flex gap-2 align-items-center" aria-current="page" href="#" aria-label="nav-links" data-bs-toggle="dropdown" aria-expanded="false">
									...
									<span class="dropdown-icon">											
										<svg width="10" height="10"><use xlink:href="#plus-icon"></use></svg> 
									</span>										
								</a>
								<ul class="dropdown-menu shadow">
									...
									<li><a class="dropdown-item" href="home-5.html" aria-label="single-pages">
											<span>Home 5</span>
										</a>
									</li>
									<li><a class="dropdown-item" href="home-6.html" aria-label="single-pages">
											<span>Home 6</span>
										</a>
									</li>	
									<li><a class="dropdown-item" href="home-7.html" aria-label="single-pages">
											<span>Home 7</span>
										</a>
									</li>														
								</ul>																		
							...
							<li class="nav-item dropdown">
								<a class="nav-link" href="about-us.html" aria-label="nav-links" >
									About Us																			   
								</a>						
							</li>	
							...
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu shadow">
									<li><a class="dropdown-item" href="service.html" aria-label="single-pages">
											<span>Service</span>												
										</a>
									</li>										
										
									<li><a class="dropdown-item" href="{{ route('services') }}" aria-label="single-pages">
										<span>Service Single 1</span>
										</a>
									</li>
									<li><a class="dropdown-item" href="{{ route('services') }}" aria-label="single-pages">
										<span>Service Single 2</span>
										</a>
									</li>
									<li><a class="dropdown-item" href="{{ route('services') }}" aria-label="single-pages">
										<span>Service Single 3</span>
										</a>
									</li>																
								</ul>																		
							</li>
									...
									<div class="row">
										<div class="col-6">
											<div class="d-flex flex-column">
												<a class="dropdown-item" href="history.html" aria-label="single-pages">
													<span>History</span>												
												</a>										
												<a class="dropdown-item" href="#" aria-label="single-pages">
													<span>Project</span>												
												</a>														
												<a class="dropdown-item" href="#" aria-label="single-pages">
												...
												<a class="dropdown-item" href="pricing.html" aria-label="single-pages">
													<span>Pricing</span>												
												</a>	
												<a class="dropdown-item" href="tracking.html" aria-label="single-pages">
										...
										<div class="col-6">
											<div class="d-flex flex-column">													
												<a class="dropdown-item" href="team.html" aria-label="single-pages">
													<span>Team</span>												
												</a>	
												<a class="dropdown-item" href="#" aria-label="single-pages">
													<span>Team Single</span>												
												</a>
												<a class="dropdown-item" href="news.html" aria-label="single-pages">
													<span>News</span>												
												</a>	
												<a class="dropdown-item" href="news-single.html" aria-label="single-pages">
													<span>News Single</span>												
												</a>													
												<a class="dropdown-item" href="login.html" aria-label="single-pages">
													<span>Login</span>												
												</a>													
												<a class="dropdown-item" href="404-page.html" aria-label="single-pages">
													<span>404 page</span>												
												</a>
							...
							<li class="nav-item">
								<a class="btn btn-primary text-uppercase" href="tracking.html">
									Tracking										   
								</a>									
							</li>							
			...
			<footer class="section-footer footer-1 bg-secondary" data-bs-theme="dark">
									...
									<div class="d-flex flex-column gap-20 gap-lg-30">
										...
										<ul class="list-unstyled mb-0 d-flex flex-column gap-10">
											<li class="d-flex gap-10 align-items-center">
												...
												<a href="{{ route('services') }}" class="text-decoration-none link-hover-animation-1">Sea Transport</a>
											</li>
											<li class="d-flex gap-10 align-items-center">
												<span class="chevron-right-icon">											
													<svg width="9" height="14"><use xlink:href="#chevron-right-icon"></use></svg> 
												</span>
												<a href="{{ route('services') }}" class="text-decoration-none link-hover-animation-1">Warehouse</a>
											</li>
											<li class="d-flex gap-10 align-items-center">
												<span class="chevron-right-icon">											
													<svg width="9" height="14"><use xlink:href="#chevron-right-icon"></use></svg> 
												</span>
												<a href="{{ route('services') }}" class="text-decoration-none link-hover-animation-1">Air Fright</a>
											</li>										
											<li class="d-flex gap-10 align-items-center">
												<span class="chevron-right-icon">											
													<svg width="9" height="14"><use xlink:href="#chevron-right-icon"></use></svg> 
												</span>
												<a href="{{ route('services') }}" class="text-decoration-none link-hover-animation-1">Local Shipping</a>
											</li>
										</ul>
									</div>	
								</div>
									...
									<div class="d-flex flex-column gap-20 gap-lg-30">
										...
										<ul class="list-unstyled mb-0 d-flex flex-column gap-10">
											...
											<li class="d-flex gap-10 align-items-center">
												...
												<a href="#" class="text-decoration-none link-hover-animation-1">Our Project</a>
											</li>
											<li class="d-flex gap-10 align-items-center">
												<span class="chevron-right-icon">											
													<svg width="9" height="14"><use xlink:href="#chevron-right-icon"></use></svg> 
				...
				<div class="container">
					<div class="copyright py-30 py-lg-40 d-flex flex-column flex-md-row gap-3 justify-content-between">						
						<p class="mb-0 copyright-text">&copy; <span class="dynamic-year"></span>, Logistip. All Rights Reserved</p>
			...
			<div class="modal modal-fullscreen routing-map-modal fade" id="RoutingMapModal" tabindex="-1" aria-labelledby="RoutingMapLabel" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						...
						<h1 class="modal-title fs-5" id="RoutingMapLabel">265 New Ave, Califonia City-1001, USA.</h1>
